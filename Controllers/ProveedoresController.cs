...
namespace TodoApi.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        {
            if (id != proveedores.Id__proveedor)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Proveedores>> PostProveedores(Proveedores proveedores)
        {
            ...
            return CreatedAtAction("GetProveedores", new { id = proveedores.Id__proveedor }, proveedores);
        }
        ...
        {
            return _context.Proveedores.Any(e => e.Id__proveedor == id);
        }
    }
}
